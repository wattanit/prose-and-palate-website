...
ratings:
  - label: "Cocktail"
    overall: 5.6
    summary: "Standard cocktail recipes, though execution rarely rises above the average."
    criteria:
      - { label: "Skill", score: 6, note: "" }
      - { label: "Recipe", score: 5, note: "" }
      - { label: "Ingredients", score: 6, note: "" }
  - label: "Place"
    overall: 5.8
    summary: "A charming bar that wins on atmosphere."
    criteria:
      - { label: "Taste", score: 5, note: "Variable execution of solid recipes." }
      - { label: "Ambiance", score: 7, note: "If the place is not crowded." }
      - { label: "Service", score: 7, note: "Enthusiastic team with genuine good intentions." }
      - { label: "Value", score: 5, note: "Could find better places for the price." }
info:
...
<Figure id="lb-whiskars-4" src="/images/posts/bars/2025/whiskars/9.jpg" alt="Old fashioned" />

<Figure id="lb-whiskars-3" src="/images/posts/bars/2025/whiskars/8.jpg" alt="Whiskar Sour" />

<Figure id="lb-whiskars-5" src="/images/posts/bars/2025/whiskars/10.jpg" alt="Socialite" />
</Row>
